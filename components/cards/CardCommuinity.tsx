...
function CardCommunity({ elements }: any) {
  return (
      ...
      {elements.map((element: any, index: number) => (
        <>
          <div className="md:w-1/3 flex flex-col items-center justify-around">
            ...
            <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-purple-700 rounded-lg hover:bg-dark-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">
              VIEW MORE
