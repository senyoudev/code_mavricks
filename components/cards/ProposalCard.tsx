      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between border-t border-b border-gray-300 py-4">
          <div className="flex items-center space-x-4">
            <button className="rounded-full px-4 py-2 text-white font-medium bg-gradient-to-r from-primaryPurple to-lightPurple hover:from-lightPurple hover:to-primaryPurple">
              For
            </button>
            <button className="rounded-full px-4 py-2 text-white font-medium bg-gradient-to-r from-primaryPink to-pinkyPurple hover:from-pinkyPurple hover:to-primaryPink">
              Against
            </button>
          </div>
